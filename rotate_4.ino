...
void setup() {
  ...
  // Turn off torque when configuring items in EEPROM area
  dxl_2.torqueOff(2);
  dxl_2.setOperatingMode(2, OP_VELOCITY);
  dxl_2.torqueOn(2);
  ...
  // Turn off torque when configuring items in EEPROM area
  dxl_3.torqueOff(3);
  dxl_3.setOperatingMode(3, OP_VELOCITY);
  dxl_3.torqueOn(3);
  ...
  // Turn off torque when configuring items in EEPROM area
  dxl_4.torqueOff(4);
  dxl_4.setOperatingMode(4, OP_VELOCITY);
  dxl_4.torqueOn(4);
}
...
void loop() {
  ...
  delay(1);
  dxl_2.setGoalVelocity(2, 25.8, UNIT_RPM);
  delay(1);
  dxl_3.setGoalVelocity(3, 25.8, UNIT_RPM);
  delay(1);
  dxl_4.setGoalVelocity(4j
  , 25.8, UNIT_RPM);
  delay(1);
